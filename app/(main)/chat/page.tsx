        ...
        <section className="flex min-h-0 flex-col overflow-hidden rounded-[28px] bg-white/[0.02] ring-1 ring-inset ring-white/[0.07]">
          ...
          <div className="border-t border-white/[0.06] bg-[#0D0F13]/80 p-3 backdrop-blur-2xl md:p-4">
            <div className="mx-auto max-w-2xl">
              ...
              <div className="flex items-center gap-1 rounded-2xl bg-white/[0.04] p-1.5 ring-1 ring-inset ring-white/10 transition-shadow focus-within:ring-[#CCFF00]/50 focus-within:shadow-[0_0_0_4px_rgba(204,255,0,0.08)]">
                <button
                  type="button"
                ...
                <input
                  ...
                  disabled={loading}
                  className="min-w-0 flex-1 bg-transparent px-1 py-2 text-[15px] text-zinc-50 placeholder-zinc-500 focus:outline-none disabled:opacity-50"
                />
                {voiceSupported && (
                  <button
                    type="button"
